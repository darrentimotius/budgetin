                ...
                <template x-for="(transfer, index) in paginatedtransfer" :key="transfer.id">
                    <tr>
                        ...
                        <td
                            :class="index === paginatedtransfer.length - 1 ? 'px-4 py-4 whitespace-nowrap' :
                                'px-4 py-4 whitespace-nowrap border-b border-gray-200 dark:border-gray-700'">
                            <div class="flex text-sm text-gray-900 dark:text-white gap-1" x-text="transfer.from_account?.name">
                            </div>
                        </td>
                        <td
                            :class="index === paginatedtransfer.length - 1 ? 'px-4 py-4 whitespace-nowrap' :
                                'px-4 py-4 whitespace-nowrap border-b border-gray-200 dark:border-gray-700'">
                            <div class="text-sm text-gray-900 dark:text-white" x-text="transfer.to_account?.name">
                            </div>
                        </td>
                        <td
                            :class="index === paginatedtransfer.length - 1 ? 'px-4 py-4 whitespace-nowrap' :
                        ...
                        <td
                            ...
                            <div class="text-sm text-gray-900 dark:text-white">
                                <div class="flex items-center w-full gap-2">
                                    <a
                                        :href="`/transfer/delete/${transfer.id}`"

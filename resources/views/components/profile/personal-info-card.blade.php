        ...
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div>
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">{{ __('common.first_name') }}</p>
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ auth()->user()->fname }}</p>
                    </div>

                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">{{ __('common.last_name') }}</p>
                    ...
                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">{{ __('common.phone') }}</p>
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">{{ auth()->user()->profile?->phone ?? '-' }}</p>
                    </div>

                    <div>
                        <p class="mb-2 text-xs leading-normal text-gray-500 dark:text-gray-400">{{ __('common.bio') }}</p>
        ...
        <div
            ...
            <div class="px-2 pr-14">
                <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                    {{ __('common.edit_personal_info') }}
                </h4>
                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                    {{ __('common.edit_personal_info_description') }}
                </p>
            </div>

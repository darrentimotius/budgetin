<x-common.component-card title="Textarea input fields">
    ...
    <div>
        ...
        <textarea placeholder="{{ __('common.description_placeholder') }}..." type="text" rows="6"
    ...
    <div>
        ...
        <textarea placeholder="{{ __('common.description_placeholder') }}..." type="text" rows="6" disabled
    ...
    <div>
        ...
        <p class="text-theme-xs text-error-500">
            {{ __('common.please_enter_message') }}
        </p>
    </div>

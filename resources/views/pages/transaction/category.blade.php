...
@section('content')
    ...
    <div
        ...
        <div x-data="{
            ...
            openCreateModal() {
                this.$dispatch('open-category-modal', { mode: 'create' });
            },
                                            ...
                                            <div class="flex items-center gap-4">
                                                <div class="flex items-center justify-center">
                                                    <i :data-lucide="category.icon"
                                                        class="w-4 h-4 text-gray-900 dark:text-white"></i>
                                                </div>
                        ...
                        <div class="custom-scrollbar flex flex-col gap-5 overflow-y-auto p-2">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" x-model="category.monthly_budget"
                                        @input="category.monthly_budget = formatRupiah($event.target.value)"
                                        placeholder="0"
